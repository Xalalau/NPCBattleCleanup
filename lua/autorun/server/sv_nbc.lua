...
local staticDelays = {
	waitForGameNewEntities = 0.09, -- The game needs some time to create new entities after a NPC dies
	waitForFilteredResults = 0.1, -- Lower values can lead to us dealing with incomplete results from GetFiltered()
